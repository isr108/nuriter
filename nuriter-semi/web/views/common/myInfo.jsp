	...
	<%@ include file="myPage_left.jsp" %>
		...
		<form action="<%=request.getContextPath()%>/updateMember" method="post">
			...
			<tr>
					...
					<td><input type="text" name="userEmail" value="<%= loginUser.getUserEmail()%>" readonly></td>
			</tr>
			<tr>
				<th>새 비밀번호</th>
				<td>
			...
			<tr>
				<th>새 비밀번호 확인</th>
				<td><input type="password" id="password2" name="password" maxlength="16" class="newPassword"></td>
			</tr>
			<tr>
				<th>닉네임</th>
			...
			<tr>
				<th><label>유저넘버</label></th>
				<td><input type="text" name="userNum" value="<%=loginUser.getUserNumber()%>"></td>
			</tr>
			<tr>
