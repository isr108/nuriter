 ...
 <!-- <br><br> <br><br> -->
   ...
   <div id="showLeft" >
     <ul class="navi2" style="list-style-type:none">
        ...
        <li id="web-font"><a href="<%=request.getContextPath()%>/views/notice/fnq.jsp">고객문의관리</a></li>
        <li id="web-font"><a href="<%=request.getContextPath()%>/views/notice/qna.jsp">자주묻는질문</a></li>
