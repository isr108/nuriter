...
import com.kh.nuriter.board.model.service.BoardService;
...
public class ReportSendServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String rtitle = request.getParameter("reportTitle");
		String rcontent = request.getParameter("reportContent");
		
		int result = new BoardService().ReportInsert(rtitle,rcontent);
